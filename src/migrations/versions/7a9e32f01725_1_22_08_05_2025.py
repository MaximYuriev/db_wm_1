...
Revision ID: 7a9e32f01725
Revises: 
Create Date: 2025-05-08 01:26:22.574518
...
def upgrade() -> None:
    ...
    sa.Column('buy_id', sa.Integer(), nullable=False),
    sa.Column('step_id', sa.Integer(), nullable=False),
    sa.Column('data_seq_beg', sa.DateTime(), nullable=False),
    sa.Column('data_seq_end', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['buy_id'], ['buy.buy_id'], ),
